<script setup lang="ts">
  ...
  const searchFormParams = ref<Partial<PositionParams>>({});
  const currentRecord = ref<Partial<PositionRecord>>({});
  // 请求分页
  const { data, isLoading } = usePositions(searchFormParams);
  // 搜索
        ...
        <a-space :size="0">
          <a-button-group>
            ...
            >
              ...
              <template #content>
                <a-doption
                  v-auth="'/system/positions:DELETE'"
